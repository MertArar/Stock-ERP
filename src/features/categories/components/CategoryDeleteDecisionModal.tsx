      ...
      <div className="w-full max-w-3xl overflow-hidden rounded-3xl bg-white shadow-2xl">
        ...
        <div className="space-y-4 px-6 py-6">
          <button
            ...
            className="flex w-full items-start gap-4 rounded-3xl border border-slate-200 bg-white p-5 text-left transition hover:border-slate-300 hover:bg-slate-50"
          >
              ...
              <div className="flex-1">
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-[1fr_auto]">
                  ...
                  <button
                    ...
                    className="h-11 rounded-2xl bg-slate-950 px-5 text-sm font-medium text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    Taşı ve Sil
                  </button>
                </div>
