...
function getToastStyles(type: ProductToastState["type"]) {
  switch (type) {
    case "success":
      return {
      ...
      >
        <path
          ...
          style={{
            strokeDasharray: 26,
            strokeDashoffset: 26,
            animation: "product-check-draw 650ms ease-out forwards",
          }}
        />
      </svg>
    </>
...
export default function ProductToast({ toast }: ProductToastProps) {
